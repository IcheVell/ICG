...
public class ModeMenu extends JMenu {
    ...
    public ModeMenu() {
        ...
        viewModeItem = new JRadioButtonMenuItem("View");
        viewModeItem.setSelected(true);

        renderModeItem = new JRadioButtonMenuItem("Render");
    ...
    public JRadioButtonMenuItem getViewModeItem() {
        return viewModeItem;
    }

    public JRadioButtonMenuItem getRenderModeItem() {
