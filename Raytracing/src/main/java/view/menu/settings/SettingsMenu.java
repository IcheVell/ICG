...
public class SettingsMenu extends JMenu {
    ...
    public JMenuItem getLoadRenderSettingsItem() {
        return loadRenderSettingsItem;
    }

    public JMenuItem getSaveRenderSettingsItem() {
        return saveRenderSettingsItem;
    }

    public JMenuItem getRenderSettingsItem() {
        return renderSettingsItem;
    }

    public JMenuItem getResetCameraItem() {
        return resetCameraItem;
    }
}